...
```{r, cache=TRUE}
lsnc <- basta(dat, studyStart = 1970, studyEnd = 2000, model = "LO",
              nsim = 2, ncpus = 2, parallel = TRUE)
```
...
```{r, cache=TRUE}
multinc <- multibasta(dat, studyStart = 1970, studyEnd = 2000, 
...
<!--- commented out until I figure out how to render the maths
## Details -- Model Fit: Deviance Information Criterion, DIC
